...
public class Room implements Closeable {
	...
	public UserSession join(String userName, Session session)
			throws IOException {
	...
	private Collection<String> joinRoom(UserSession newParticipant)
		...
		for (final UserSession participant : participants.values()) {
			try {
				newParticipantMsg.addProperty("user", participant.getName());
	...
	private void removeParticipant(String name) throws IOException {
		...
		for (final UserSession participant : participants.values()) {
			try {
				participantLeftJson.addProperty("user", participant.getName());
	...
	public void sendParticipantNames(UserSession user) throws IOException {
		...
		existingParticipantsMsg.addProperty("user", user.getName());
